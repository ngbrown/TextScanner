...
This is a port of the Java class "java.util.Scanner":http://java.sun.com/javase/7/docs/api/java/util/Scanner.html to .NET.
...
The .NET implementation of the "Java tutorial":http://java.sun.com/docs/books/tutorial/essential/io/scanning.html would look like this:<pre><code>
 namespace ScanXan
 {
    using System;
    using System.IO;
...
The output is the same:<pre><code>
In
Xanadu
did
Kubla
...
The @ScanSum@ example reads a list of double values and adds them up. Here's the source:<pre><code>
 namespace ScanSum
 {
    using System;
